...
const App = () => {
  // State variables
  const [khodam, setKhodam] = useState<{ name: string; meaning: string } | null>(null); // Holds current khodam
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen dark:bg-gray-900 bg-gradient-to-r from-purple-300 to-blue-200">
            ...
            <Form className="flex flex-col gap-4">
              ...
              {isSubmitted && khodam && (
                <div className="mt-6 bg-green-100 border-l-4 border-green-500 text-green-700 p-4" role="alert">
                  ...
                  <p>
                    Halo {submittedName}, Khodamu adalah:{" "}
                  </p>
                  <span className="font-bold text-blue-500 text-xl">
                      {khodam.name}
                    </span>
                  <p><span className="text-gray-900">
              ...
              {(isSubmitted || loading) && (
                <button
                  type="button"
                  className="mt-2 bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
                  onClick={() => {
