                          ...
                          items: {
                            ...
                            properties: {
                              ...
                              poster: {
                                type: 'string',
                                example:
                                  'https://otakudesu.cloud/wp-content/uploads/2024/08/Momochi-san-Chi-no-Ayakashi-Ouji-Sub-Indo.jpg'
                              },
                              episode_count: {
                                type: 'string',
                                example: '12'
                    ...
                    data: {
                      ...
                      properties: {
                        ...
                        stream_url: {
                          type: 'string',
                          example:
                            'https://desudrive.com/dstream/playdesu/index.php?id=NStDZzRCRmpmeWRsRFRCOGNrZU16M2loQ2FvSWJHcS9tKzJ1c2FSMWNLMD0='
                        },
                        download_urls: {
                          type: 'object',
                          properties: {
                                    ...
                                    items: {
                                      ...
                                      properties: {
                                        ...
                                        url: {
                                          type: 'string',
                                          example:
                                            'https://desustream.com/safelink/link/?id=eXRoOHNYVG9UdnVmNVNPQ2x6WmpBNnVjZWFhV2pNTzVqeXhTY2VybmhtUURuVld0bjM0YitsaFVBczZxOFpHL2pRPT0='
                                        }
                                      }
                                    }
                                  }
                          ...
                          items: {
                            ...
                            properties: {
                              ...
                              synopsis: {
                                type: 'string',
                                example:
                                  'Himari Momochi yang baru saja berulang tahun ke-16 mendapatkan sebuah surat wasiat yang menyebutkan bahwa ia mewarisi sebuah rumah milik keluarga Hyakusenke.'
                              },
                              otakudesu_url: {
                                type: 'string',
                                example: 'https://otakudesu.cloud/anime/momochisan-sub-indo/'
